...
namespace FBRxweb.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(FBRxweb.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(FBRxweb.Models.Main.LanguageContent.ComponentLanguageContents))]
